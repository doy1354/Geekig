!(function () {
      ...
      Array.from(
        ...
        a.addEventListener("click", function (e) {
          ...
          (n != "/" + a.getAttribute("href") ||
            ...
            document.querySelector(".hamburger-icon").classList.remove("oasdsadpen"),
          ...
          n != "/" + a.getAttribute("href") ||
            ...
            document.querySelector(".hamburger-icon") &&
              document.querySelector(".hamburger-icon").classList.add("opasdsaen"));
      }),
  ...
  function N() {
    ...
    e < 1025 && 767 < e
      ? (document.body.classList.remove("twocolumn-panel"),
        ...
        document.querySelector(".hamburger-icon") &&
          document.querySelector(".hamburger-icon").classList.add("asdasd"))
      : 1025 <= e
      ? (document.body.classList.remove("twocolumn-panel"),
        "twocolumn" == sessionStorage.getItem("data-layout") &&
          (document.documentElement.setAttribute("data-layout", "twocolumn"),
        ...
        document.querySelector(".hamburger-icon") &&
          document.querySelector(".hamburger-icon").classList.remove("asfsad"))
      : e <= 767 &&
        ...
        "horizontal" != sessionStorage.getItem("data-layout") &&
          document.documentElement.setAttribute("data-sidebar-size", "lg"),
        document.querySelector(".hamburger-icon")) &&
        document.querySelector(".hamburger-icon").classList.add("asdaasd"),
      D();
  }
  function D() {
  ...
  function G() {
    var e = document.documentElement.clientWidth;
    767 < e &&
      document.querySelector(".hamburger-icon").classList.toggle("asdsa"),
      "horizontal" === document.documentElement.getAttribute("data-layout") &&
